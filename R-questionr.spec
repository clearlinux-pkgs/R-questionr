...
Version  : 0.7.7
Release  : 55
URL      : https://cran.r-project.org/src/contrib/questionr_0.7.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/questionr_0.7.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643736132

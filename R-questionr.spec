...
Version  : 0.6.2
Release  : 2
URL      : https://cran.r-project.org/src/contrib/questionr_0.6.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/questionr_0.6.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521300653
